...
import Squares from "../MainPage/components/Background"
...
export default function Overview() {
    return (
        <section className="relative bg-black">
            {/* 上端フェード（グラデーション） */}
            <div className="absolute top-0 left-0 w-full h-40 pointer-events-none z-10" style={{
            ...
            <main className="relative bg-black/80">
                    <div className="px-8 space-y-4 md:col-span-1 py-40">
                        <h2 className="text-4xl font-mono font-bold mb-2 text-white">活動概要</h2>
                        <div className="w-80 h-px bg-white rounded-full mb-8" />
                        <div className="space-y-4 text-white/90 font-mono font-normal leading-relaxed">
                            <p>{content[0].description}</p>
                            <p>{content[1].description}</p>
                        </div>
                    </div>
                    <div className="flex flex-row px-8">
                    <div className="text-white/90 p-8 space-y-4 md:col-span-1 py-40 max-w-lg font-normal">
                        <h2 className="text-xl font-bold">GSE</h2>
                        <p>GSE（Ground Support Equipment）は、ロケットの打上げを支援するための地上設備を指します。CREATEでは、GSEの設計・製作にも力を入れており、実際の打上げに向けたテストや整備を行っています。</p>
                    </div>
                    <div className="">
                        <Image 
                        src="/gse.jpg" 
